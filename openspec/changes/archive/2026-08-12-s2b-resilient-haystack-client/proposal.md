...
1. Agree behavior via OpenSpec delta + Spec-Kit pack + SPDD REASONS + living haystack-recommender SoT.
...
| Living SoT | [`openspec/specs/haystack-recommender/spec.md`](../../../specs/haystack-recommender/spec.md) |
| Portal contract | [`openspec/specs/haystack-recommender/contracts/portal-api.md`](../../../specs/haystack-recommender/contracts/portal-api.md) |
| Spec-Kit (audit only) | [`spec-kit/`](./spec-kit/) |
