...
| `RentalPlan` | `rental_plan` | customer FK; status DRAFT/SAVED/QUOTED/CONVERTED; `createdAt` set on create; `updatedAt` is last-quoted-at (also refreshed on quoted item mutation); DTO postal-code rule on create |
